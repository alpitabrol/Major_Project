//Program for printing the first html page for the user interface.
#include<iostream>
...

{
	...
	cout
			<< "body{ background-image: url(https://www.forumhealthcentre.nhs.uk/UserFiles/Thumbnails/Wellness_Health_Lifestyle/shutterstock_67699489_1__h1000_w500.jpg);} "
			<< endl;
	...
	cout
			<< ".loginform{width:410px;margin:20px auto;padding:25px;background-color:#FFF8DC;border-radius:5px;box-shadow:0px 0px 5px 0px #DEB887;inset 0px 1px 0px 0px rgba(250,250,250,0.5);border:1px solid rgba(0,0,0,0.3);}"
			<< endl;
	cout
			<< ".loginform2 {width:700px;margin:20px auto;padding:25px;background-color:#FFF8DC;border-radius:5px;box-shadow:0px 0px 5px 0px #DEB887;inset 0px 1px 0px 0px rgba(250,250,250,0.5);border:1px solid rgba(0,0,0,0.3);}"
			<< endl;
	...
	cout << ".loginform input[type=submit] {"
			<< "border: 1px solid rgba(0, 0, 0, 0.3);" << "background: #64c8ef;"
			...
			<< "color: #fff;	padding: 5px 15px;	margin-right: 0;margin-top: 15px;border-radius: 3px;text-shadow: 1px 1px 0px rgba(0, 0, 0, 0.3);}"
			<< endl;
	...
	cout
			...
			<< endl;
	cout
			<< "<h2 class=\"loginform2 cf\"align=\"center\" style=\"color: FireBrick;\"><font size=\"3\">Nutrtitional"
			...
			<< "<br>For Details:<a target=\"_blank\"href=\"https://github.com/alpitabrol/NUTRITIONAL-TRACKER\"</font\">\"Click here\"</a></font> </h2>"
			<< endl;
	cout
			<< "<h3 align=\"center\" style=\"color: Black;\"><font size=\"6\">Let's get your 5 portion of Vegetables & Fruits!</font> </h3>"
			<< endl;
	cout << "</div>" << endl;
	cout << "<div class=\"loginform cf\">" << endl;
	cout
			<< "<form name=\"login\" action=\"server_conn\" method=\"get\" accept-charset=\"utf-8\">"
			<< endl;
	cout << "<ul>" << endl;
	cout << "<li>" << endl;
	cout << "<label for=\"username\">Username</label>" << endl;
	cout
			<< "<input type=\"username\" name=\"username\" placeholder=\"Your Name\" required>"
			<< endl;
	cout << "</li>" << endl;
	...
	cout
			<< "<div><a href=\"https://github.com/alpitabrol\"><img style=\"position: absolute;"
			...
			<< " data-canonical-src=\"https://s3.amazonaws.com/github/ribbons/forkme_right_red_aa0000.png\"></a></div>"
			<< endl;
	cout
			<< "<h5 align = \"right\" style= \"color: 9B1650\"><font size=\"5\">Thanks for using our Product.</font></h5>"
			<< endl;

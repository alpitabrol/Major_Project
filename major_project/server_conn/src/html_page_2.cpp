...
void html_page(int count,string second_page_info[20][7],int days_to_go, int portions_to_go)
{
	...
	cout<<"body{ background-image: url(https://images.pexels.com/photos/616404/pexels-photo-616404.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260);"
	...
	cout<< "<caption align = \"center\" style= \"color: 9B16500\">A Portion: Pieces counted as 1 portion. Count: Consumable Portions we have</caption>"<<endl;
	cout<<" <tr>"<<endl;
	...
	cout<<"<h3 style= \"color: Blue\">Wow, Your nutrition has been completed for "<<days_to_go<<" days. ";
	if(portions_to_go)
	{
	cout<<"You still have "<<portions_to_go<<" portions for the following day.";
	}
    cout<<"</h3>"<<endl;

    cout<<"<h5 align = \"right\" style= \"color: 9B1650\"><font size=\"4\">Thanks for using our Product.</font></h5>"<<endl;
